...
public class ONSEmailGroupParserHandlerTest {
    ...
    @Test
    public void testONSEmailGroupParserHandler() {
        ONSEmailGroupParserHandler handler = new ONSEmailGroupParserHandler(s3Client);
